...
class LogBot(irc.IRCClient):
    nickname = 'AxelBrosefBot' # nickname
    password = '' # server pass
    realname = "Do you even bro, bro?"
    nickservPass = ''
    
    quotes = {
            "cat" : "Nyancat is the baddest cat in the sky. Nothing attacks him. So why would he ever look up? - Reddit circa 2014",
            "gym" : "GYM TAN HACKING, BRO!!!",
            "hint" : "Bro, no hint for you.",
            "help" : "Bro. No. Just no.",
            "cyber" : "Bro, I love cyber.",
            "shell" : "Yo bro, I heard you like shells.",
            "work" : "Terminate the diagnostic, re-route the encryption.",
            "bro" : "Bro."
        }
